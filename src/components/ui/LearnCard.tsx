...
export function LearnCard({ icon: Icon, title, description }: Props) {
  return (
    <div className="group glass-card glass-card-hover rounded-2xl border border-warm-300 p-6 card-lift cursor-default">
      <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-gold-400/20 to-gold-600/10 border border-gold-400/20 text-gold-400 flex items-center justify-center mb-5 group-hover:shadow-[0_0_20px_rgba(232,118,28,0.3)] transition-shadow duration-300">
        <Icon size={18} />
      </div>
