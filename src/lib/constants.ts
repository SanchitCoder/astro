...
export const PHONE = '+91 95551 40404';
export const PHONE_TEL = 'tel:+919555140404';
export const EMAIL = 'info@sadhguruanand.com';
export const EMAIL_MAILTO = `mailto:${EMAIL}`;
export const WHATSAPP_URL = 'https://wa.me/919555140404';
